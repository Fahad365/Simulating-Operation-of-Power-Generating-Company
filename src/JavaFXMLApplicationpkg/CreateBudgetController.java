...
public class CreateBudgetController implements Initializable {
    ...
    @FXML
    private Button FinancialSummary;
    @FXML
    private Button Back;
    ...
    @FXML
    private void FinancialSummaryButtonOnClick(ActionEvent event) throws IOException {
        Parent userScene = FXMLLoader.load(getClass().getResource("FinancialSummary.fxml"));
