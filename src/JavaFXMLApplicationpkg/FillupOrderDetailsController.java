 ...
 * @author HP
 */
public class FillupOrderDetailsController implements Initializable {
    ...
    @FXML
    private RadioButton ElectronicBankTransfers;
    @FXML
    private Button Back;
    ...
    @FXML
    private void PaymentMethode(ActionEvent event) {
    }
